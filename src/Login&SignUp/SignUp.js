...
import { adddata } from '../Account/ContextProvider';
...
// const IMG = "https://demo-537.reallysimplesystems.com/img/login-bg.png";
...
//           <Grid overflow={'hidden'} sx={{ backgroundColor: theme.palette.primary.main, borderRadius: 2, border: 0.5, borderColor: theme.palette.primary.liveScoreBoxShadowColor,  maxWidth:"50%" }}  p={1} mt={2} mb={2}>

//             <Grid display={'flex'} flexDirection={"column"} textAlign={"center"}>
//               <Typography>Really Simple Systems</Typography>
//               <Typography fontWeight={'bolder'} color="#343D67">Sign up for your Free CRM Trial</Typography>
//               <Typography sx={{color:"#727883"}}>Our CRM free trial uses our Professional plan with the Marketing tool activated, so you can best see how the CRM could work for you.</Typography>
//             </Grid>
...
//                   }
//                 </Button>
//                 <Divider sx={{borderColor:"#9e9e9e"}}></Divider>
//                 <Grid display={'flex'} flexDirection={"row"} justifyContent={"space-evenly"} mt={2}>
//                 <Typography mt={1}>Already have an account ?</Typography>
//                 <Button
